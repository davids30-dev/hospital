...
public class ControllerCrud {
    ...
    public Map<String, String> saveDoctores(@RequestBody Map<String, String> request) {
        ...
        doctores.setNombre(request.get("nombre"));
        doctores.setApellidoPaterno(request.get("apellidoPaterno"));
        doctores.setApellidoMaterno(request.get("apellidoMaterno"));
        try{
        ...
        response.put("message", "Datos agregados correctamente");
    ...
    public Map<String,String> getCitas() {
        List<Consultorio> listaConsultorio = consultorioRepository.findAll();
        Map<String,String> response = new HashMap<>();
        for (Consultorio consultorio : listaConsultorio){
            response.put(consultorio.getId().toString(),
